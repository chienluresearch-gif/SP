...
if args.treatment_feature_model in ['SatlasLandSat', 'SatlasSentinel2']:
    ...
    if treatment_mapping_config.treatment_freeze == True:
        log_freeze_flag = '_freeze'    
...
logger = CSVLogger("EuroSAT_Emb" + str(args.seed), name="EuroSAT_Emb" + str(args.seed)) 
...
csv_file = 'metrics/EuroSAT_SaST_metric.csv'
