...
# treatment_feature_config.backbone = 'DenseNet169'
...
#    experiment_name="LICS_ConCate",
#    tracking_uri=tracking_uri
#)

logger = CSVLogger("LICS_Concate" + str(args.seed), name="LICS_Concate" + str(args.seed)) 
...
csv_file = 'metrics/Concate_metric.csv'
