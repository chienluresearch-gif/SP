...
# Create the parser
parser = argparse.ArgumentParser(description="args for nice-vgg baseline")
...
treatment_feature_config.backbone = 'VGG16'
...
#     experiment_name="LICS_NICE_VGG",
#     tracking_uri=tracking_uri
# )

logger = CSVLogger("LICS_NICE" + str(args.seed), name="NICE_VGG" + str(args.seed)) 
